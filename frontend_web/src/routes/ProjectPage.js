...
function ProjectPage(){
    ...
    return (
        <div id='ProjectPage'>
            ...
            {projectInfo?.title ? 
                <Routes>
                    <Route index element={<MapPage title={ projectInfo?.title } drawers={ projectInfo?.boundariesCollection } area={ projectInfo?.area } center={ center } />} />
                    <Route path='map' element={<MapPage title={ projectInfo?.title } drawers={ projectInfo?.boundariesCollection } area={ projectInfo?.area } center={ center }/>} />
                    <Route path='activities' element={<ActivityPage title={ projectInfo?.title }  drawers={ projectInfo?.boundariesCollection } />} />
                    <Route path='activities/times' element={<NewActivityTimes />}/>
                    <Route path='surveyors' element={<SurveyorPage title={ loc.state } drawers={  projectInfo?.boundariesCollection } />} />
                </Routes> 
                : 
                null
            }
