...
function replaceOutsideStrings(e, r) {
  return r % 2 == 0 ? e.replace(i, " ").trim() : e;
}

function stringifyDocument(r) {
  var t = ("string" != typeof r ? r.loc && r.loc.source.body || e.print(r) : r).split(a).map(replaceOutsideStrings).join("");
  if ("string" != typeof r) {
...
var f = "undefined" != typeof TextDecoder ? new TextDecoder : null;
...
exports.makeFetchSource = function makeFetchSource(e, t, n) {
  ...
  return r.make((function(r) {
    var i = r.next;
    var s = r.complete;
    var p = "undefined" != typeof AbortController ? new AbortController : null;
    if (p) {
      n.signal = p.signal;
    }
    var h = !1;
      ...
      return i().then((function next(n) {
        if (!n.done) {
          var a = function toString(e) {
            return "Buffer" === e.constructor.name ? e.toString() : f.decode(e);
          }(n.value);
          var s = a.indexOf(o);
          if (s > -1) {
            s += d.length;
          ...
          while (s > -1) {
            var u = d.slice(0, s);
            var l = d.slice(s + o.length);
            if (v) {
              v = !1;
            } else {
              var p = u.indexOf("\r\n\r\n") + 4;
              var g = u.slice(0, p);
              var x = u.slice(p, u.lastIndexOf("\r\n"));
              var b = void 0;
              if (c.test(g)) {
                try {
                  b = JSON.parse(x);
                  m = y = y ? mergeResultPatch(y, b, t) : makeResult(r, b, t);
                } catch (e) {}
              }
...
//# sourceMappingURL=18d86276.js.map
