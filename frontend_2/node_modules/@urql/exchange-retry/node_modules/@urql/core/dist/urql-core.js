...
var u = function Client(e) {
  ...
  function makeResultSource(e) {
    var i = r.filter((function(t) {
      return t.operation.kind === e.kind && t.operation.key === e.key && (!t.operation.context._instance || t.operation.context._instance === e.context._instance);
    }))(x);
    if (l.maskTypename) {
      i = r.map((function(e) {
        return t._extends({}, e, {
  ...
  var l = t._extends(f, {
    ...
    createRequestOperation: function createRequestOperation(e, r, n) {
      ...
      var o = l.createOperationContext(n);
      if ("mutation" === e) {
        o._instance = [];
      }
      return makeOperation(e, r, o);
    },
  ...
  var ssr = function(u) {
    ...
    return function(u) {
      ...
      var d = r.map((function(e) {
        ...
        return !!i[e.key] && "network-only" !== e.context.requestPolicy;
      }))(f));
      if (!p) {
        l = r.tap((function(e) {
          var t = e.operation;
