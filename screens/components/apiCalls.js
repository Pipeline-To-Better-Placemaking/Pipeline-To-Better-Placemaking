...
export async function getProject(project) {
  ...
  try {
      const response = await fetch(HEROKU_SERVER+'/projects/' + project._id, {
          method: 'GET',
          headers: {
...
export async function getTeam(team) {
  ...
  try {
      const response = await fetch(HEROKU_SERVER+'/teams/' + team._id, {
          method: 'GET',
          headers: {
              Accept: 'application/json',
                  'Content-Type': 'application/json',
...
export async function postInvite(id, claim) {
  ...
  let result = null;
  try {
      const response = await fetch(HEROKU_SERVER+'/users/invites/', {
          method: 'POST',
          headers: {
              Accept: 'application/json',
                  'Content-Type': 'application/json',
...
export async function getUserInfo() {
  ...
  let userInfo = null;
  try {
      const response = await fetch(HEROKU_SERVER+'/users/', {
          method: 'GET',
          headers: {
              Accept: 'application/json',
                  'Content-Type': 'application/json',
...
export async function getCollection(route, collection) {
  ...
  try {
    const response = await fetch(HEROKU_SERVER+'/collections/' +
...
async function helperGetResultDetails(resultId, routePath) {
  ...
  let res = null
  try {
      const response = await fetch(HEROKU_SERVER+'/' + routePath + resultId, {
          method: 'GET',
          headers: {
              Accept: 'application/json',
                  'Content-Type': 'application/json',
